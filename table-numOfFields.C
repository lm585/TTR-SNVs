...
int main(int argc, char *argv[])
{
 if(argc != 2)
 {
  cerr << argv[0] << "  tab-delimited-file" << endl;
  cerr << "The program outputs the number of fields delimited by A SINGLE tab" << endl;
  cerr << "It also outputs number of fields that are not null" << endl;
  cerr << "line_1	53(fields)	30(fields NOT NULL" << endl;
  return 1;
 }
